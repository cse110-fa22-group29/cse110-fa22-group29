...
describe("test sort/filter localStorage interaction", () => {
	...
	it("test getReviewsByTag end behavior after create", () => {
		...
		for (let i = 0; i < specific_tagged_reviews.length; i++) {
			assert.strictEqual(
				specific_tagged_reviews[i].tags.includes("tag 0"),
				true
			);
		...
		for (let i = 0; i < specific_tagged_reviews.length; i++) {
			assert.strictEqual(
				specific_tagged_reviews[i].tags.includes("tag 1"),
				true
			);
		...
		for (let i = 0; i < specific_tagged_reviews.length; i++) {
			assert.strictEqual(
				specific_tagged_reviews[i].tags.includes("tag 2"),
				true
			);
		...
		for (let i = 0; i < specific_tagged_reviews.length; i++) {
			assert.strictEqual(
				specific_tagged_reviews[i].tags.includes("tag true"),
				true
			);
		...
		for (let i = 0; i < specific_tagged_reviews.length; i++) {
			assert.strictEqual(
				specific_tagged_reviews[i].tags.includes("tag false"),
				true
			);
			assert.strictEqual(specific_tagged_reviews[i].reviewID >= 50, true);
		}
	...
	it("test getReviewsByTag end behavior after update", () => {
		...
		for (let i = 0; i < specific_tagged_reviews.length; i++) {
			assert.strictEqual(
				specific_tagged_reviews[i].tags.includes("tag 3"),
				true
			);
